...
public class SMObjectMetadata {
    ...
    public void setUserMetadata(Map<String, String> userMetadata) {
        assertParameterNotNull(userMetadata, "userMetadata");
    ...
    public Date getExpirationTime() {
        return (Date) metadata.get(OSSHeaders.EXPIRES);
    }
...
/*        if (contentLength > OSSConstants.MAX_FILESIZE) {
     ...
     * 设置Object服务器端熵编码的类型
     *
     * @param serverSideEncryption 服务器端加密的熵编码类型
     */
