...
public final class Parameter {
    ...
    private DTDBType dtdbType;
    private List<Parameter> parameterList;
    private List<Parameter> parameterList2;

    public Parameter(String name, Object value, Object value2, DTDBType dtdbType) {
        this.name = name;
        this.value = value;
        this.value2 = value2;
    ...
    public Parameter(String name, Object value, DTDBType dtdbType) {
    ...
    public Parameter(List<Parameter> parameterList, DTDBType dtdbType) {
        this.parameterList = parameterList;
        this.dtdbType = dtdbType;
    }
    ...
    public DTDBType getDtdbType() {
        return dtdbType;
    }

    public void setDtdbTypee(DTDBType dtdbType) {
        this.dtdbType = dtdbType;
    }
