...
// i18n
gulp.task('templates:i18n',function () {
    return gulp.src(source.other.i18n.files)
        .on("error", handleError)
        .pipe(gulp.dest(build.other.i18n.dir))
        ;
});

// image
gulp.task('templates:img',function () {
    return gulp.src(source.other.img.files)
        .on("error", handleError)
        .pipe(gulp.dest(build.other.img.dir))
        ;
});
//---------------
// WATCH
...
gulp.task('watch', function () {
    ...
    gulp.watch(source.other.i18n.watch, ['templates:i18n']);
    gulp.watch(source.other.img.watch, ['templates:img']);
